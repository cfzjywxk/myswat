...
class MySwatMCPDispatcher:
    ...
    def __init__(self, service: MySwatToolService) -> None:
        ...
        self._tools: dict[str, MCPTool] = {
            ...
            "append_coordination_event": MCPTool(
                name="append_coordination_event",
                description="Append a coordination event to the workflow event stream.",
                schema_model=CoordinationEventRecord,
                handler=self._service.append_coordination_event,
            ),
            ...
            "fail_review_cycle": MCPTool(
                name="fail_review_cycle",
                description="Mark a claimed review cycle as terminally failed.",
                schema_model=ReviewFailureSubmission,
                handler=self._service.fail_review_cycle,
            ),
            "cancel_review_cycles": MCPTool(
                name="cancel_review_cycles",
                description="Cancel a set of outstanding review cycles.",
                schema_model=ReviewCycleCancellationRequest,
                handler=self._service.cancel_review_cycles,
            ),
